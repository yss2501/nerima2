...
import { api, Spot, SpotUpdate } from '@/lib/api';
...
export default function EditSpotForm({ spot, onSpotUpdated, onCancel }: EditSpotFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 成功時の処理
      if (onSpotUpdated && response.data) {
        onSpotUpdated(response.data);
      }
      ...
      setErrors({ submit: 'スポットの更新に失敗しました' });
    } finally {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="low">低価格（～1,000円）</option>
        ...
        <div>
          <label className="flex items-center space-x-2">
            <input
              type="checkbox"
              checked={formData.weather_dependent || false}
